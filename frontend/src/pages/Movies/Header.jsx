...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center bg-[rgb(17,17,43)] px-5 py-2 text-white shadow-[0_4px_8px_rgba(59,59,171,0.4)] fixed w-full top-0 left-0 h-[60px] z-10">
      <Link
        to="/"
        className="text-4xl w-[200px] h-[70px] font-bold flex items-center"
      >
