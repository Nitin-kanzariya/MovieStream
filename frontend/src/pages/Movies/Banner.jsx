    ...
    >
      ...
      >
        ...
        <button
          ...
          className="absolute left-2 md:left-4 lg:left-8 top-1/2 -translate-y-1/2 p-1.5 md:p-2 lg:p-3 rounded-full bg-black/30 text-white backdrop-blur-sm hover:bg-black/50 transition-colors duration-300 z-1"
        ...
        <button
          ...
          className="absolute right-2 md:right-4 lg:right-8 top-1/2 -translate-y-1/2 p-1.5 md:p-2 lg:p-3 rounded-full bg-black/30 text-white backdrop-blur-sm hover:bg-black/50 transition-colors duration-300 z-1"
        ...
        {/* Slide indicators */}
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex space-x-2 z-0">
...
// select top 7 random movie code ==>
...
//   // Function to randomly select 6 movies
//   const getRandomMovies = (movies, count) => {
//     const shuffled = [...movies].sort(() => Math.random() - 0.5);
//     return shuffled.slice(0, count).map((movie) => ({
//       image: movie.bannerImage || movie.image, // Adjust the property name based on your movie schema
...
//   // Populate slides dynamically based on movies
//   useEffect(() => {
...
//         {/* Slide indicators */}
//         <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex space-x-2 z-1">
//           {slides.slice(1, slides.length - 1).map((_, idx) => (
//             <button
//               key={idx}
//               className={`w-2 h-2 md:w-2.5 md:h-2.5 rounded-full transition-all duration-300 ${
//                 currentIndex === idx + 1
